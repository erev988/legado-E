...
class McpService : BaseService() {
    ...
    private fun stopServiceWithNotification() {
        ...
        activeAddressKeys = emptyList()
        postEvent(EventBus.MCP_SERVICE, "")
        val builder = createNotification(terminal = true)
    ...
    override fun startForegroundNotification() {
        val builder = createNotification(terminal = stopping)
        startForeground(NotificationId.McpService, builder.build())
    }

    private fun createNotification(terminal: Boolean = false): NotificationCompat.Builder {
